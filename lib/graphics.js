...
module.exports = function (graphicsDir, manifest) {
    ...
    if (fs.existsSync(graphicsDir) && typeof manifest.graphics === 'undefined') {
        throw new Error('This bundle has a "graphics" folder, '
    ...
    if (!fs.existsSync(graphicsDir) && typeof manifest.graphics !== 'undefined') {
        throw new Error('This bundle has a "nodecg.graphics" property in its package.json, '
    ...
    manifest.graphics.forEach(function(graphic, index) {
        ...
        if (dupeFound) {
            throw new Error(
                format('Graphic #%d (%s) has the same file as another graphic in this bundle.', index)
            );
        }
