...
module.exports = function (dashboardDir, manifest) {
    ...
    if (fs.existsSync(dashboardDir) && typeof manifest.dashboardPanels === 'undefined') {
        throw new Error('This bundle has a "dashboard" folder, '
    ...
    if (!fs.existsSync(dashboardDir) && typeof manifest.dashboardPanels !== 'undefined') {
        throw new Error('This bundle has a "nodecg.dashboardPanels" property in its package.json, '
    ...
    manifest.dashboardPanels.forEach(function(panel, index) {
        ...
        if (dupeFound) {
            throw new Error(
                format('Panel #%d (%s) has the same name as another panel in this bundle (%s).',
